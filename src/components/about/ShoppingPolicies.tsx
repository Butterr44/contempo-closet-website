    ...
    <div className="max-w-3xl mx-auto mb-16">
      ...
      <Accordion type="single" collapsible className="w-full bg-white/50 rounded-xl shadow-sm">
        <AccordionItem value="payment">
          <AccordionTrigger className="text-lg font-medium px-4 sm:px-6">Payment</AccordionTrigger>
        ...
        <AccordionItem value="shipping">
          <AccordionTrigger className="text-lg font-medium px-4 sm:px-6">Shipping & Handling</AccordionTrigger>
          <AccordionContent className="text-gray-600 px-4 sm:px-6">
        ...
        <AccordionItem value="international">
          <AccordionTrigger className="text-lg font-medium px-4 sm:px-6">International Shipping</AccordionTrigger>
          <AccordionContent className="text-gray-600 px-4 sm:px-6">
        ...
        <AccordionItem value="condition">
          <AccordionTrigger className="text-lg font-medium px-4 sm:px-6">Item Conditions</AccordionTrigger>
          <AccordionContent className="text-gray-600 px-4 sm:px-6">
        ...
        <AccordionItem value="feedback">
          <AccordionTrigger className="text-lg font-medium px-4 sm:px-6">Feedback Policy</AccordionTrigger>
          <AccordionContent className="text-gray-600 px-4 sm:px-6">
